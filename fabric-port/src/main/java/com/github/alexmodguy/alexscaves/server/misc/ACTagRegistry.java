...
public final class ACTagRegistry {
    ...
    public static final TagKey<Fluid> ACID = registerForgeFluidTag("acid");
    ...
    private static TagKey<Fluid> registerForgeFluidTag(String name) {
